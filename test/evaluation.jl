...
categorical_level_labels = DimArray([
        ...
        CategoricalLevelDim([:ControlGroup, :TargetGroup])], CategoricalVariableDim([:Treatment, :Subject, :Experimenter, :ClinicalGroup]))
...
random_effect_term_labels = DimArray([
        ...
        DimArray([
                ...
                RandomEffectTermDim([:Intercept, :Age_first])], random_effect_factor_labels),
        ...
        DimArray([
                ...
                RandomEffectTermDim(Symbol[])], random_effect_factor_labels)], regression_labels)
...
random_effect_group_labels = DimArray([
        ...
        RandomEffectGroupDim([:SingleGroup])], random_effect_factor_labels)
...
random_effect_block_labels = DimArray([
        ...
        RandomEffectBlockDim([:SingleBlock])], random_effect_factor_labels)
...
group_assignments = DimArray([
        ...
        #Factor 2: Experimenter
        DimArray([:SingleGroup, :SingleGroup, :SingleGroup], categorical_level_labels[At(:Experimenter)])], random_effect_factor_labels)
...
block_assignments = DimArray([
        ...
        DimArray([
                ...
                DimArray([:SingleBlock, :SingleBlock], random_effect_term_labels[At(:Performance)][At(:Experimenter)])], random_effect_factor_labels),
        ...
        DimArray([
                ...
                DimArray(Symbol[], random_effect_term_labels[At(:Accuracy)][At(:Experimenter)])], random_effect_factor_labels)
    ], regression_labels)
...
random_effect_geometries = DimArray([
        ...
        #Factor 2: Experimenter
        Centered], random_effect_factor_labels)
...
fixed_effect_priors = DimArray([
        ...
        DimArray(
            fill(Normal(0, 1), 5),
            fixed_effect_term_labels[At(:Accuracy)])], regression_labels)
        ...
        DimArray([
                ...
                DimArray([
                        ...
                        DimArray(
                            ...
                            random_effect_term_labels[At(:Performance)][At(:Subject)])], random_effect_group_labels[At(:Subject)]),
                ...
                DimArray([
                        ...
                        DimArray(
                            ...
                            random_effect_term_labels[At(:Performance)][At(:Experimenter)])], random_effect_group_labels[At(:Experimenter)])], random_effect_factor_labels),
        ...
        DimArray([
                ...
                DimArray([
                        ...
                        DimArray(
                            ...
                            random_effect_term_labels[At(:Accuracy)][At(:Subject)])], random_effect_group_labels[At(:Subject)]),
                ...
                DimArray([
                        ...
                        DimArray(Gamma{Float64}[],
                            random_effect_term_labels[At(:Accuracy)][At(:Experimenter)])], random_effect_group_labels[At(:Experimenter)])], random_effect_factor_labels)], regression_labels)
...
random_effect_correlation_LKJcholesky_priors = DimArray([
        ...
        DimArray([
                ...
                DimArray([
                        ...
                        # Block 3: ResidualBlock (2 terms: the intercepts)
                        nothing #No correlation
                    ], random_effect_block_labels[At(:Subject)])], random_effect_group_labels[At(:Subject)]),
        ...
        DimArray([
                ...
                DimArray([
                        ...
                        LKJCholesky(2, 1.0)], random_effect_block_labels[At(:Experimenter)])], random_effect_group_labels[At(:Experimenter)])], random_effect_factor_labels)
...
basis_matrix_r1 = DimArray(hcat(
        ...
        treatment_r1 .== 3), (observation_labels[At(:Performance)], basis_term_labels[At(:Performance)]))
...
fixed_effects_design_matrix_r1 = DimArray(hcat(
        ...
        basis_matrix_r1[:, At(:Age_first)] .* basis_matrix_r1[:, At(:Treatment_High)]), (observation_labels[At(:Performance)], fixed_effect_term_labels[At(:Performance)]))
...
random_effect_design_matrices_r1 = DimArray([
        ...
        basis_matrix_r1[:, At([:Intercept, :Age_first])]], random_effect_factor_labels)
...
terms_info_r1 = (Intercept=TermInfo(
        ...
        dependent_interaction_indices=DependentInteractionIndices(Int[], Tuple{Int,Int}[])), Age=TermInfo(
...
basis_matrix_r2 = DimArray(hcat(
        ...
        # Variable 3: BMI
        randn(n_observations_r2)), (observation_labels[At(:Accuracy)], basis_term_labels[At(:Accuracy)]))
...
fixed_effects_design_matrix_r2 = DimArray(hcat(
        ...
        # Term 5: max(Age, BMI)
        max.(basis_matrix_r2[:, At(:Age)], basis_matrix_r2[:, At(:BMI)])), (observation_labels[At(:Accuracy)], fixed_effect_term_labels[At(:Accuracy)]))
...
random_effect_design_matrices_r2 = DimArray([
        ...
        DimArray(Matrix{Float64}(undef, n_observations_r2, 0), (observation_labels[At(:Accuracy)], RandomEffectTermDim(Symbol[])))], random_effect_factor_labels)
...
## 7. Create info for each term ##
terms_info_r2 = (Intercept=TermInfo(
        basis_expansion_type=IdentityExpansion(),
        basis_matrix_indices=[1],
        fixed_effects_indices=[1],
...
simplereg_likelihoods = (
    ...
    DistributionLikelihood(
        LogNormal,
        (μ=(:Accuracy, exp), σ=truncated(Normal(), lower=0))
    )
)
